...
@SpringBootTest(classes = SpringBootTicketTestingAppApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class TicketBookingControllerIntegrationTest {
	...
	public void testGetTicketById() throws Exception {
		...
		ticket.setBookingDate("2/3/2019");
